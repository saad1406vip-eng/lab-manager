...
/* ═══════════════════════════════════════════════════════════
   تكملة SUPPLY_DATA — c311 + e411 + Dimension + VIDAS + VARIANT
   ═══════════════════════════════════════════════════════════ */

/* ─────────────────────────────────────────────
   Cobas c311 (كيمياء فقط — يشترك في المعايرة والـQC مع C303 في Pure)
   ───────────────────────────────────────────── */
SUPPLY_DATA.c311 = [
  /* ══ كواشف كيمياء ══ */
  ...
  /* ══ معايرات (مشتركة مع C303 في Pure — انظر SHARED_RULES) ══ */
  ...
  /* ══ محاليل تشغيل — خاصة بـ c311 (تختلف عن C303) ══ */
  { id: "c311_sol_0", name: "ISE Inter Standard",       type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },
  { id: "c311_sol_1", name: "ISE Diluent G2",           type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },
  { id: "c311_sol_2", name: "ISE REF Electrolyte",      type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },
  { id: "c311_sol_3", name: "Cell Wash Solution 1 / NAOHD", type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },
  { id: "c311_sol_4", name: "Cell Wash Solution 2 / Acid Wash", type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },
  { id: "c311_sol_5", name: "Sample Cleaner 1",         type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },
  { id: "c311_sol_6", name: "Sample Cleaner 2",         type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ c311" },

  /* ══ قطع غيار c311 ══ */
  { id: "c311_part_0", name: "Na Electrode",        type: "Part", qty: 0, minQty: 1, kitDays: 90, note: "إلكترود" },
  { id: "c311_part_1", name: "K Electrode",         type: "Part", qty: 0, minQty: 1, kitDays: 90, note: "إلكترود" },
  { id: "c311_part_2", name: "Cl Electrode",        type: "Part", qty: 0, minQty: 1, kitDays: 90, note: "إلكترود" },
  { id: "c311_part_3", name: "REF Electrode",       type: "Part", qty: 0, minQty: 1, kitDays: 90, note: "إلكترود" },
...
/* ─────────────────────────────────────────────
   Cobas e411 (هرمونات + فيروسات — يشترك في المعايرة والـQC مع e402 في Pure)
   ───────────────────────────────────────────── */
SUPPLY_DATA.e411 = [
  /* ══ كواشف هرمونات ══ */
  ...
  /* ══ معايرات (مشتركة مع e402 في Pure) ══ */
  ...
  /* ══ محاليل تشغيل — خاصة بـ e411 (تختلف عن e402) ══ */
  { id: "e411_sol_0", name: "ProCell",        type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ e411" },
  { id: "e411_sol_1", name: "CleanCell",      type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ e411" },
  { id: "e411_sol_2", name: "PreClean",       type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ e411" },
  { id: "e411_sol_3", name: "SysClean",       type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "خاص بـ e411" },
...
SUPPLY_DATA.dimension = [
  ...
  { id: "dim_cal_10", name: "Verify Enz",         type: "Calibrator", qty: 0, minQty: 3, kitDays: 60, note: "فحص إنزيمات" },
  { id: "dim_cal_11", name: "Chek Lyte Solution", type: "Calibrator", qty: 0, minQty: 3, kitDays: 60, note: "فحص ومعايرة إلكتروليتات" },
  ...
  { id: "dim_sol_2", name: "Standard F",  type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "" },
  { id: "dim_sol_3", name: "Salt",        type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "" },
  { id: "dim_sol_4", name: "Diluent",     type: "Solution", qty: 0, minQty: 3, kitDays: 30, note: "" },
  { id: "dim_sol_5", name: "CHE",         type: "Solution", qty: 0, minQty: 3, kitDays: 21, note: "فحص أداء الجهاز — احتياج ضروري" },
...
/* ─────────────────────────────────────────────
   Mini VIDAS (طوارئ — bHCG + Troponin فقط)
   ───────────────────────────────────────────── */
SUPPLY_DATA.vidas = [
  ...
  { id: "vidas_6", name: "SPR (Solid Phase Receptacle)", type: "Part", qty: 0, minQty: 1, kitDays: 90, note: "قطع خاصة" },
  { id: "vidas_7", name: "VIDAS Waste Bag",        type: "Part",       qty: 0, minQty: 1, kitDays: 90, note: "كيس نفايات" }
];

/* ─────────────────────────────────────────────
   VARIANT II (HbA1c فقط)
   ───────────────────────────────────────────── */
SUPPLY_DATA.variant = [
...
/* ═══════════════════════════════════════════════════════════
   قائمة كاملة بأسماء الاختبارات لكل جهاز (لاستخراجها من الأصناف)
   ═══════════════════════════════════════════════════════════ */
var DEVICE_TEST_NAMES = {
  atellica:    ["GLU","UREA","CREA","UA","Na","K","Cl","Ca","PHOS","Mg","ALT","AST","ALP","GGT","TBIL","DBIL","TP","ALB","CHOL","TG","HDL","LDL","CK","CK-MB","LDH","AMY","LIP","CRP","Fe-Iron","TIBC","NH3","Lactate","HbA1c","Microalbumin","UCFP",
                "TSH","FT4","FT3","LH","FSH","Prolactin","HCG-Beta","Vitamin-B12","Ferritin","AFP","CEA","Progesterone","Cortisol","PSA","Estradiol","Folate","Testosterone","PTH","Vitamin-D","CK-MB","NT-proBNP","Troponin","Anti-Tg","Procalcitonin","HBsII","aHCV","CHIV","SYPH","aHBs2","C-peptide","Insulin","CA-19-9","CA-15-3","CA-125","Her-2"],
...
/* ═══════════════════════════════════════════════════════════
   ربط الاختبارات بأصنافها (لحساب الجاهزية)
   ═══════════════════════════════════════════════════════════ */
var TEST_REQUIREMENTS = {
  /* كل اختبار له متطلباته — يتم ملؤها ديناميكيًا من SUPPLY_DATA */
  /* هذا الكائن يُبنى في shared.js */
};
